...
MT5LINUX_SERVER_DIR="${MT5LINUX_SERVER_DIR:-$PY_WINE_PREFIX/drive_c/mt5linux-server}"
...
export MT5LINUX_HOST
export MT5LINUX_PORT
export MT5LINUX_SERVER_DIR
...
"$WRITER_SCRIPT" \
  ...
  --host "$MT5LINUX_HOST" \
  --port "$MT5LINUX_PORT" \
  --server-dir "$MT5LINUX_SERVER_DIR"
