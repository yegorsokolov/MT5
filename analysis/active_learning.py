...
class ActiveLearningQueue:
    ...
    def __init__(self, queue_path: Path = QUEUE_PATH, labeled_path: Path = LABELED_PATH) -> None:
...
def merge_labels(df: pd.DataFrame, labeled: pd.DataFrame, label_col: str) -> pd.DataFrame:
