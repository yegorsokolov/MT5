...
FEATURE_SCHEMA = pa.DataFrameSchema(
    {
        ...
        "dividend": pa.Column(float, required=False, nullable=True),
        "split": pa.Column(float, required=False, nullable=True),
        "insider_trades": pa.Column(float, required=False, nullable=True),
        "institutional_holdings": pa.Column(float, required=False, nullable=True),
